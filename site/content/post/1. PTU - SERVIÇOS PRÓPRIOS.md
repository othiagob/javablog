...
[^1]: Z:\Gerência Atenção Saúde\3 - Procedimentos Assistenciais\CONTAS MÉDICAS\2026\FATURAS A550 CNCL - 2026

[^2]: Um detalhe importante é que quando emitimos o serviços próprios será no mês de competência **01/2026**. Provavelmente na data **05/02**, sendo assim após enviar o arquivo **PTU** no **GIU**. Vamos ter que voltar na mensalidade no **modulo estrutural** e alterar a data de emissão para **05/02/2026** que é o mês referente a competência que enviamos e depois vincular a **NOTA FISCAL**.
